...
def app(unused_argv):
  """ Generates 7 sequences (6 primers), each one used as the primer for the next generation.  The final output is named "generated"."""

bundles = ("wativ.mag", "angry.mag", "booker.mag", "wativ.mag", "duo.mag", "wativ.mag", "duo.mag")
filenames = ["primer.mid", "primer1.mid", "primer2.mid", "primer3.mid", "primer4.mid", "primer5.mid", "IV.machine_speechPrimer_sam_angry_7bar_200bpm2.mid"]
steps = []
bars = [16, 4, 4, 4, 4, 4, 4]
...
primers = ["sam_angry_7bar_200bpm.mid", "primer.mid", "primer1.mid", "primer2.mid", "primer3.mid", "primer4.mid", "primer5.mid"]
...
for x in range (len(bars)):
      ...
      generate( 
        bundle_name=bundle,
        sequence _generator=polyphony_sequence_generator,
