...
def app(unused_argv):
  """ Generates 6 sequences (5 primers), each one used as the primer for the next generation.  The final output is named "generated"."""

bundles = ("booker.mag", "booker.mag", "amused_OnF.mag", "monk_60sec.mag", "duo.mag", "wativ.mag")
filenames = ["primer.mid", "primer1.mid", "primer2.mid", "primer3.mid", "primer4.mid", "I.human_speechPrimer_bea_neutral_50bpm_2bars_OnF6.mid"]
steps = []
bars = [6, 2 , 4, 4, 2, 1]
s_p_q = [4, 4, 8, 4, 8, 8] 
totalBars = 0
...
primers = ["bea_neutral_50bpm_2bars_OnF.mid", "primer.mid", "primer1.mid", "primer2.mid", "primer3.mid", "primer4.mid"]
