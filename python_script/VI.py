...
def app(unused_argv):
  """ Generates 8 sequences, each one used as the primer for the next generation.  The final output is named "generated"."""

bundles = ("amused.mag", "wativ.mag", "amused.mag", "wativ.mag" "angry.mag", "duo.mag", "monk_60sec", "neutral.mag")
filenames = ["primer.mid", "primer1.mid", "primer2.mid", "primer3.mid", "primer4.mid", "primer5.mid", "primer6.mid" "VII.machine_speech_bea_amused_6bars_120.mid"]
steps = []
bars = [24, 8, 8, 8, 8]
s_p_q = [4, 16, 32, 1, 2] 
totalBars = 0
...
primers = ["bea_amused_6bars_120.mid", "primer.mid", "primer1.mid", "primer2.mid", "primer3.mid", "primer4.mid", "primer5.mid", "primer6.mid"]
