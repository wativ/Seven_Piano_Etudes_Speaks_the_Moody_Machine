...
def app(unused_argv):
  """ Generates 3 sequences (2 primers), each one used as the primer for the next generation.  The final output is named "generated"."""

bundles = ("neutral_onF.mag", "booker.mag", "wativ.mag")
filenames = ["primer.mid", "primer1.mid", "III.human_musicPrimer_wativ_slow18bars3.mid"]
steps = []
bars = [20, 8, 8]
s_p_q = [1, 2, 2] 
totalBars = 0
