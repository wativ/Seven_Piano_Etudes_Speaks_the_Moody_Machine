...
bundles = ("angry.mag", "booker.mag", "wativ.mag", "monk_60sec.mag", "angry.mag", "duo.mag")
filenames = ["primer.mid", "primer1.mid", "primer2.mid", "primer3.mid", "primer4.mid", "II.machine_musicPrimer_wativ_arp_187bpm_14bar.mid1"]
steps = []
bars = [24, 24, 8, 8, 12, 2]
s_p_q = [8, 4, 8, 16, 8, 4] 
totalBars = 0
...
primers = ["wativ_arp_187bpm_14bar.mid", "primer.mid", "primer1.mid", "primer2.mid", "primer3.mid", "primer4.mid"]
